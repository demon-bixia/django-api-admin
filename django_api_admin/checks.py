...
class APIBaseModelAdminChecks:
    def check(self, admin_obj, **kwargs):
        return [
            ...
            *self._check_serializer(admin_obj),
    ...
    def _check_radio_fields_value(self, obj, val, label):
        ...
        from django_api_admin.admins.base_admin import HORIZONTAL, VERTICAL
...
class APIModelAdminChecks(APIBaseModelAdminChecks):
    ...
    def _check_inlines_item(self, obj, inline, label):
        ...
        try:
            ...
            return [
                checks.Error(
                    "'%s' must inherit from 'APIInlineModelAdmin'." % obj,
                    obj=obj.__class__,
                    id="admin.E104",
                )
            ]

        if not _issubclass(inline, InlineAPIModelAdmin):
            return [
                checks.Error(
                    "'%s' must inherit from 'InlineAPIModelAdmin'." % inline_label,
                    obj=obj.__class__,
                    id="admin.E104",
                )
            ]
    ...
    def _check_list_display_links(self, obj):
        ...
        # Check only if APIModelAdmin.get_list_display() isn't overridden.
    ...
    def _check_list_filter_item(self, obj, item, label):
        ...
        """
        from django_api_admin.filters import FieldListFilter, ListFilter
    ...
    def _check_action_permission_methods(self, obj):
        """
        Actions with an allowed_permission attribute require the APIModelAdmin to
